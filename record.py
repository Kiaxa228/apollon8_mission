...
fields = ['Time', 'Velocity', 'GForce', 'Accelaration', 'Thrust', 'TWR', 'AltitudeFromTerrain', 'AltitudeFromSea', 'DownrangeDistance', 'Latitude', 'Longitude', 'Apoapsis', 'Periapsis', 'Inclination', 'OrbitalVelocity', 'TargetDistance', 'TargetVelocity', 'StageDeltaV', 'VesselDeltaV']
rows = [] 
...
with open('stats.csv', 'a') as f:
    ...
    while True:
        ...
        rows.append([cur_time, srf_speed, gforce, acelaration, thrust, twr, altitude, altitudeFromSea, 0, latitude, longitude, apoapsis, periapsis, inclination, orbital_velocity])
